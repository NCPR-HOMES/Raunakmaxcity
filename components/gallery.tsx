...
const galleryImages = {
  exterior: [
    { src: "/placeholder.svg?height=600&width=800", alt: "Building Exterior 1" },
    { src: "/placeholder.svg?height=600&width=800", alt: "Building Exterior 2" },
    { src: "/placeholder.svg?height=600&width=800", alt: "Building Exterior 3" },
    { src: "/placeholder.svg?height=600&width=800", alt: "Building Exterior 4" },
  ],
  interior: [
    { src: "/placeholder.svg?height=600&width=800", alt: "Living Room" },
    { src: "/placeholder.svg?height=600&width=800", alt: "Kitchen" },
    { src: "/placeholder.svg?height=600&width=800", alt: "Bedroom" },
    { src: "/placeholder.svg?height=600&width=800", alt: "Bathroom" },
  ],
  amenities: [
    { src: "/placeholder.svg?height=600&width=800", alt: "Swimming Pool" },
    { src: "/placeholder.svg?height=600&width=800", alt: "Gym" },
    { src: "/placeholder.svg?height=600&width=800", alt: "Garden" },
    { src: "/placeholder.svg?height=600&width=800", alt: "Clubhouse" },
  ],
  construction: [
    { src: "/placeholder.svg?height=600&width=800", alt: "Construction Progress 1" },
    { src: "/placeholder.svg?height=600&width=800", alt: "Construction Progress 2" },
    { src: "/placeholder.svg?height=600&width=800", alt: "Construction Progress 3" },
    { src: "/placeholder.svg?height=600&width=800", alt: "Construction Progress 4" },
  ],
}
    ...
    <section id="gallery" className="section-padding bg-muted/30 clip-path-slant">
      <div className="container-custom">
        ...
        <Tabs defaultValue="exterior" className="w-full">
          <TabsList className="grid w-full grid-cols-4 mb-8 rounded-full p-1">
